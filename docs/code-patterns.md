...
> Note: the worked examples here predate the move to the Capacitor `frontend-app/`
> client and use the legacy Expo/React-Native flavor. The *workflow and patterns*
> still apply; treat the specific component code as illustrative, not current.
