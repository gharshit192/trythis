...
import { getCategoryMeta, categoryMatchesFilter } from '../../lib/categoryMeta';
import { relativeTime, isVideo, formatDistance } from '../../lib/format';
            ...
            return (
              <div key={save._id} className="cv-item" onClick={() => onNavigate('save-detail', { id: save._id })}>
                ...
                <div className="cv-dist" style={distLabel ? {} : { color: 'var(--mute)', fontWeight: 500, fontSize: 11 }}>
                  {distLabel || relativeTime(save.createdAt)}
                </div>
              </div>
            );
          })}
